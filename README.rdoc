...
and maybe validate with the other validation macros.
  
The <tt>amount_field</tt> helper also formats the value with <tt>number_with_precision</tt>.
You can explicitly set the value too:
